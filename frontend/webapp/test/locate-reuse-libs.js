var fioriToolsGetManifestLibs = function (manifestPath) {
    ...
    return fetch(url).then(function (response) {
        if (!response.ok) {
            throw new Error("Could not fetch manifest at '" + manifestPath);
        }
...
var registerComponentDependencyPaths = function (manifestPath) {
    ...
    return fioriToolsGetManifestLibs(manifestPath).then(function (libs) {
        if (libs && libs.length > 0) {
            ...
            var sapClient = new URLSearchParams(window.location.search).get("sap-client");
...
registerComponentDependencyPaths(manifestUri)
    ...
    .finally(function () {
        ...
        sap.ui.require(["sap/ui/core/Core", "sap/base/i18n/Localization"], function (Core, Localization) {
            Core.ready(function () {
        ...
        if (componentName && componentName.length > 0) {
            if (useMockserver && useMockserver === "true") {
                sap.ui.require(["sap/ui/core/Core"], function (Core) {
                    Core.ready(function () {
                        registerSAPFonts();
                        sap.ui.require([componentName.replace(/\./g, "/") + "/localService/mockserver", "sap/ushell/Container"], function (server, Container) {
